...
function Navbar() {
  ...
  return (
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-25 ${
          sticky
        ...
        <div className="navbar bg-base-100 dark:bg-slate-900 dark:text-white">
          ...
          <div className="navbar-end space-x-8 dark:bg-slate-900 dark:text-white">
            ...
            <div className="navbar-end ">
              <a className="bg-black font-serif text-white p-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer "
